...
const MoneyMakerPro: React.FC = () => {
  ...
  // Filtered and sorted opportunities with unified sport filtering
  const filteredOpportunities = useMemo(() => {
    // First filter by sport using unified filtering
    let filtered = filterSportData(opportunities, selectedSport, {
    ...
    return filtered;
  }, [opportunities, selectedFilter, selectedSport, sortBy]);
